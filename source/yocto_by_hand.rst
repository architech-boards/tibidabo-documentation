...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="yocto_by_hand_rst-host-84" class="language-markup">repo init -u https://github.com/architech-boards/tibidabo-manifest.git -b dora -m manifest.xml</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
 </div>
...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="yocto_by_hand_rst-host-87" class="language-markup">git clone -b dora https://github.com/architech-boards/meta-tibidabo.git</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
 </div>
