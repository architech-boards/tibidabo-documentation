...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-board">&nbsp;&nbsp;Board&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'boot_rst-board-251' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="boot_rst-board-251" class="language-markup">fuse prog 0 5 0x00001040
...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-board">&nbsp;&nbsp;Board&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'boot_rst-board-252' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="boot_rst-board-252" class="language-markup">fuse prog 0 5 0x18000030
 fuse prog 0 6 0x00000010</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
 </div>
...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="boot_rst-host-41" class="language-markup">sudo apt-get install libusb-1.0 libusb-dev libusb-1.0-0-dev
...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="boot_rst-host-42" class="language-markup">./imx_usb /path/to/your/u-boot.imx</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
 </div>
...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="boot_rst-host-43" class="language-markup">cd /path/to/imx_usb
...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-board">&nbsp;&nbsp;Board&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'boot_rst-board-253' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="boot_rst-board-253" class="language-markup">sf probe
 sf erase 0x64000
...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="boot_rst-host-44" class="language-markup">/path/to/u-boot/sources/include/configs/tibidabo.h</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
 </div>
...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="boot_rst-host-45" class="language-markup">sudo dd if=/path/to/image.sdcard of=/path/to/your/sd/card/device</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
 </div>
...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="boot_rst-host-46" class="language-markup">sudo dd if=/path/to/u-boot.imx of=/path/to/your/sd/card/device bs=1k seek=1</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
 </div>
...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="boot_rst-host-47" class="language-markup">setenv bootargs ${bootargs} vmalloc=400M root=/dev/mmcblk0p2 rw,rootwait consoleblank=0 video=mxcfb0:dev=hdmi,1280x720M@60,if=RGB24 video=mxcfb1:dev=lcd,CLAA-WVGA,if=RGB666 fbmem=28M,10M
 mmc dev 0
...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="boot_rst-host-48" class="language-markup">./create-bootscript.sh -i /path/to/your/u-boot/script -o /path/to/where/to/emit/the/final/bootscript</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
 </div>
