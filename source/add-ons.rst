...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-host">&nbsp;&nbsp;Host&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'add_ons_rst-host-191' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="add_ons_rst-host-191" class="language-markup">patch -p1 -d ~/Documents/linux-2.6-imx/ &lt; ~/Documents/0002-tibidabo-huawei.patch</code></pre>
